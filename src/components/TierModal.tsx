...
import { X, Award, CheckCircle2, Crown, Sparkles, TrendingUp, Info, Table, LayoutGrid } from 'lucide-react';
...
export const TierModal: React.FC<TierModalProps> = ({
  ...
  const [modalTab, setModalTab] = useState<'matrix' | 'cards'>('matrix');
  ...
  return (
    ...
    >
      <div
        className="bg-white rounded-3xl max-w-5xl w-full overflow-hidden shadow-2xl border border-gray-100 animate-in zoom-in-95 duration-150 relative max-h-[92vh] flex flex-col"
      ...
      >
        ...
        <div className="bg-slate-900 text-white p-5 sm:p-6 relative">
          ...
          <h3 className="text-xl sm:text-2xl font-black text-white">
            Dialog Star Points Tier Structure & Benefit Types
          </h3>
          ...
          <p className="text-xs sm:text-sm text-gray-300 mt-1">
            ...
            You need <strong className="text-white">{profile.pointsToNextTier.toLocaleString()} more points</strong> to reach Platinum (Min. Balance: 50,000).
          </p>
          ...
          <div className="flex items-center gap-2 mt-4">
            ...
            >
              ...
              <span>Assessment Matrix Table</span>
            </button>
            <button
              type="button"
            ...
            >
              ...
              <span>Tier Comparison Cards</span>
            </button>
          </div>
        </div>
        ...
        <div className="p-4 sm:p-6 overflow-y-auto flex-1 space-y-6">
          {modalTab === 'matrix' ? (
            <TierAssessmentMatrix currentTier={profile.tier} />
          ) : (
